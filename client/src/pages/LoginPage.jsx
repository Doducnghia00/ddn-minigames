            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="text-center mb-8 animate-slide-down">
                    ...
                    <h1 className="text-5xl font-black mb-3">
                        <span className="gradient-text">DDN Games</span>
                    </h1>
                    <p className="text-gray-400 text-lg">Enter the arena of mini-games</p>
                </div>
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                disabled
                                className="w-full px-4 py-3 bg-slate-900/50 border border-slate-700 rounded-lg text-white placeholder-gray-600 opacity-50 cursor-not-allowed"
                            />
                        </div>
                        ...
                        <button
                            disabled
                            className="w-full mt-6 py-3.5 bg-slate-700 text-gray-500 font-bold rounded-lg cursor-not-allowed opacity-50"
                        >
